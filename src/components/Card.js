        ...
        <>
            <div className="md:block hidden">
                <div className="relative">
                    <div className="bg-[#2f2f2f] w-1/2 px-8 absolute bottom-10 left-28 z-0 card1">
                        ...
                        <button className="text-[#f5f5f5] border font-semibold border-[#f5f5f5] mb-6 py-3 px-10">
                            Download Brochure
                        </button>
                    </div>
            ...
            <div className="md:hidden">
                <div className="pt-20 pb-10 flex flex-col justify-center items-center">
                    ...
                    <button className="text-[#131313] border-2 font-semibold border-[#131313] mb-6 py-3 px-10">
                        Download Brochure
                    </button>
                </div>
