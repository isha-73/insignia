export default function Floorplan() {
    return (
        <div className="flex flex-col justify-center items-center relative my-20 px-6 md:px-10 lg:px-20">
            <h2 className="font-hb text-4xl text-center">
                FLOOR PLAN
            </h2>
            <img src="/images/sep.png" alt="sep" className="mx-auto mb-10 md:mb-20" />
