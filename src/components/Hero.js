...
export default function Hero() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 w-[100vw] bg-[#F5EEE6] relative">
            ...
            <div className="hidden relative md:flex flex-col px-2 md:px-10 lg:pl-20 h-full md:-mt-16 lg:-mt-28 justify-center items-start">
                <div className="flex items-center">

                <h1 className="text-[#D8B25D] font-hb md:text-4xl lg:text-[62px] font-bold mb-8">
                    INSIGNIA
                </h1>
                <span className="text-[#151109] ml-4 font-hb md:text-[30px] lg:text-3xl font-bold mb-8">
            ...
            <div className="flex md:justify-end justify-center w-full items-center">
                ...
                <div className="md:hidden absolute h-full flex flex-col px-8 justify-end items-center bg-[#000000aa] py-16">
                    <h1 className="text-[#D8B25D] font-hb font-bold text-5xl text-center">
                        INSIGNIA
                    </h1>
                    <h1 className="text-[#F5EEE6] font-hb font-bold text-xl mb-8 text-center">
                        THE CROWN OF DADAR
                    </h1>
